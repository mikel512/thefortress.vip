...
namespace vApplication.Migrations
{
    ...
    [Migration("20230823234318_AppUserVenue")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("vDomain.Entity.ApplicationUser", b =>
                {
                    ...
                    b.Property<bool>("MailingListEnabled")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("vDomain.Entity.ApplicationUserVenue", b =>
                {
                    ...
                    b.HasKey("ApplicationUserId", "VenueId");

                    b.HasIndex("VenueId");

                    b.ToTable("AppUserVenue");
                });
            ...
            modelBuilder.Entity("vDomain.Entity.ApplicationUserVenue", b =>
                {
                    b.HasOne("vDomain.Entity.ApplicationUser", "ApplicationUser")
                        .WithMany()
                        .HasForeignKey("ApplicationUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("vDomain.Entity.Venue", "Venue")
                        .WithMany()
